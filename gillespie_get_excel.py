"""
Fetches an Excel file from the web and saves it locally as 'basketball.xlsx'
...
def main():
    """
    Main function to fetch Excel data.
    """
    excel_url = 'https://github.com/aarongilly/datafun-03/raw/refs/heads/main/NCAA_Mens_Basketball_Championship_History.xlsx'
    logger.info("Starting Excel fetch...")
    fetch_excel_file(fetched_folder_name, "basketball.xlsx", excel_url)
